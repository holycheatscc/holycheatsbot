...
module.exports.run = async (bot, message, args) => {
    ...
    if(aUser.roles.find(r => r.id === botconfig["ticket_system"].support_role)) return message.channel.send(`Du hast nicht auszureichende Rechte!`).then(msg => msg.delete(5000));
